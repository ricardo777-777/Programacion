...
\end{equation} generan una curva llamada _parábola_, la excentricidad es el cociente de estas dos distancias que es igual a $1$ pues ambas son iguales a $\left|p\right|$.

# Final Words
1. Al realizarse una transformacion de coordenadas, el eje de una parabola $\mathcal{P}$ resulta orientada segun el vector $(3,4)$. En $x'y'$ un punto $Q'=(20,-20)'\in\mathcal{P}$ en els sistema $xy$ el foco de $\mathcal{P}$ $E=(11,5)$. Determinar en el sistema $xy$ un punto $R$ de la parabola $\mathcal{P}$ tal que el trinagulo $QVR$ sea rectangulo en $V$ vertice de la parábola.  
...
<!--
```{r 94, echo=FALSE, fig.cap="ww", fig.align="center"}
knitr::include_graphics("94.svg")
```
-->
